...
public class FieldE extends JButton {
	 ...
	 */
	private int calculatePointsForFirstBlock(DiceE[] dices, int n) {
		int result = 0;
	...
	private int calculatePointsForFullHouse(DiceE[] dice) {
	 ...
	 */
	private int calculatePointsForLargeStraight(DiceE[] dice) {
